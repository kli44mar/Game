...
"При этом уровень воды во всех стаканах одинаковый. Ответ запишите цифрой"] = "2",
...
"Плоды, какого растения использовались при изготовлении этих погремушек?"] = "гороха"
            ...
            new Dictionary<string, string>
            {
                ...
                "У меня нет ни сестер, ни братьев, но отец этого человека был сыном моего отца" + ". Кто был изображен на портрете?"] = "сын",
                ["Для того чтобы получить краску оранжевого цвета, необходимо смешать краски желтого цвета (6 частей) и красного цвета (2 части). Сколько грамм краски оранжевого цвета можно получить (максимально), имея в наличии 3 грамма желтой и 3 грамма красной краски?"] = "4"
                },
            1,
            new List<string> { "Initial" },
            Level3);
            ...
            Level5 = new Level(new Dictionary<(int, string), string>
            {
                ...
                [(1, "(7x + 1)(3x - 1) - 21x^2 = 3")] = "948",
                [(1, "log {5} (3x − 11) + log {5} (x − 27) = log {5} 8 + 3")] = "37",
            },
            2,
            new List<string>
            {
            ...
            new Dictionary<string, string>
            {
                ["При издании книги потребовалось 2 775 цифр того, чтобы пронумеровать ее страницы. Сколько страниц в книге?"] = "961",
